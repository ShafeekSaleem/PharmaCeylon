...
/** Map pin — used for Settings → Branches. */
...
/** Expanding corner arrows — enter fullscreen. */
...
/** Inward corner arrows — exit fullscreen. */
...
/** Viewfinder brackets — POS focus mode (hides app chrome around the counter). */
