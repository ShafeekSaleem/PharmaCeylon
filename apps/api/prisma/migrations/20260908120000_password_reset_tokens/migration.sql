...
--
-- Not tenant-scoped by design: the requester is unauthenticated and app_user.email
-- is globally unique, so the token is the only credential. Mirrors staff_invitation,
-- which is reachable the same way.
...
CREATE INDEX "password_reset_token_user_id_used_at_idx"
