...
export const PERMISSION_CATALOG: PermissionDefinition[] = [
  ...
  },
  {
    ...
    description: "Quarantine/release batches, post stock adjustments, process supplier returns.",
    defaultRoles: [owner, manager, inventory_clerk],
    riskLevel: "elevated",
  ...
  },
  {
    ...
    description: "Quarantine all expired batches in one action.",
    defaultRoles: [owner, manager],
    riskLevel: "elevated",
    dependencies: ["inventory.view"],
  },
  {
    key: "inventory.customer_returns",
    module: "inventory",
    label: "Process customer returns",
    description: "Post a customer return at the counter.",
    defaultRoles: [owner, manager, pharmacist, cashier],
  },
  ...
  },
  {
    ...
    description: "Access tenant-level management settings.",
    defaultRoles: [owner, manager],
    riskLevel: "sensitive",
  },
