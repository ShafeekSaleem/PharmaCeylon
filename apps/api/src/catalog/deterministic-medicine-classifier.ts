...
const RETAIL_CLASSIFICATION_RULES: MedicineClassificationRule[] = [
  ...
  {
    canonicalKey: "PERSONAL_CARE_DEODORANTS",
    keywords: ["DEODORANT", "ANTIPERSPIRANT", "ROLL ON"],
  },
  {
    canonicalKey: "BABY_CARE_DIAPERS",
    keywords: ["DIAPER", "NAPPY", "NAPPIES", "PANT STYLE"],
  },
  {
  ...
  {
    canonicalKey: "BABY_CARE_FEEDING",
    keywords: ["FEEDING BOTTLE", "TEAT", "SOOTHER", "PACIFIER"],
  },
  {
  ...
  {
    canonicalKey: "MEDICAL_DEVICES_NEBULIZERS",
    keywords: ["NEBULIZER", "NEBULISER"],
  },
  {
  ...
  {
    canonicalKey: "FOOD_BEVERAGE_WATER",
    keywords: ["MINERAL WATER", "DRINKING WATER"],
  },
  {
  ...
  {
    canonicalKey: "FOOD_BEVERAGE_CONFECTIONERY",
    keywords: ["CHOCOLATE", "TOFFEE", "CANDY"],
  },
  {
...
const DOSAGE_FORM_RULES: Array<{ canonicalKey: string; patterns: RegExp[] }> = [
  {
    canonicalKey: "MEDICINES_EYE_EAR",
    patterns: [/EYE/, /OPHTHALMIC/, /\bOTIC\b/, /\bEAR\b/],
  },
  {
    canonicalKey: "MEDICINES_DERMATOLOGY",
    patterns: [/\bCREAM\b/, /\bOINTMENT\b/, /\bGEL\b/, /\bLOTION\b/],
  },
